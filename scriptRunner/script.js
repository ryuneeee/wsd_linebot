...
module.exports = function (sandbox, code){
    ...
    try {
        ...
        domain.once('error', (e) => { printError(e); });
        domain.run(function() {
            Function.prototype.toString = hiddenFunction;

            let script = new vm.Script(arguments[1], { lineOffset: 1, displayErrors: true});
            script.runInNewContext(arguments[0], {timeout: timeout});
