        ...
        try {
            ...
            if (domain._events.error === undefined)
                domain.on('error', (error) => {
                    if(this._events.error !== undefined) this.emit('error', error, sandbox); else console.error(error);
                });
            ...
            if(this._events.error !== undefined) this.emit('error', error, sandbox); else throw error;
        } finally {
            Function.prototype.toString = Object.prototype.toString;
        }
    }
